...
class CustomerRegistrationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'last_name.max' => 'Achternaam mag niet langer zijn dan 255 karakters.',
            'phone.max' => 'Telefoonnummer mag niet langer zijn dan 20 karakters.',
            'street.max' => 'Straat mag niet langer zijn dan 255 karakters.',
            ...
            'total_members.integer' => 'Aantal gezinsleden moet een getal zijn.',
            'total_members.min' => 'Aantal gezinsleden moet minimaal 1 zijn.',
            'total_members.max' => 'Aantal gezinsleden mag niet meer dan 20 zijn.',
        ]);
        ...
        try {
            ...
            return back()
                ->withErrors(['error' => 'De ingevoerde gegevens zijn niet geldig. Controleer de verplichte velden en probeer het opnieuw.'])
