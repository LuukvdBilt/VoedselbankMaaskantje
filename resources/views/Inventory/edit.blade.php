<x-layouts::app :title="__('Magazijn item wijzigen')">
    <div class="container mx-auto px-4 py-8 dark:bg-gray-900">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-green-400">{{ __('Magazijn item wijzigen') }}</h1>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <form action="{{ route('inventory.update', $inventoryItem->Id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="ProductName" id="ProductName" value="{{ old('ProductName', $inventoryItem->ProductName) }}" 
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Barcode" id="Barcode" value="{{ old('Barcode', $inventoryItem->Barcode) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    @error('Barcode')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Category" id="Category" value="{{ old('Category', $inventoryItem->Category) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    @error('Category')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="Quantity" id="Quantity" value="{{ old('Quantity', $inventoryItem->Quantity) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    @error('Quantity')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="ExpirationDate" id="ExpirationDate" 
                           value="{{ old('ExpirationDate', $inventoryItem->ExpirationDate ? \Carbon\Carbon::parse($inventoryItem->ExpirationDate)->format('Y-m-d') : '') }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="InventoryNote" id="InventoryNote" rows="3" 
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('InventoryNote', $inventoryItem->InventoryNote) }}</textarea>
                    @error('InventoryNote')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="ProductNote" id="ProductNote" rows="3" 
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('ProductNote', $inventoryItem->ProductNote) }}</textarea>
                    @error('ProductNote')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
