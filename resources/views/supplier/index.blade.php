                    ...
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        @forelse($suppliers as $supplier)
                            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-900/50">
                                <td class="px-6 py-4 text-neutral-900 dark:text-neutral-100">{{ $supplier->company_name }}
                                </td>
                                <td class="px-6 py-4 text-neutral-600 dark:text-neutral-400">{{ $supplier->address }}</td>
                                <td class="px-6 py-4 text-neutral-900 dark:text-neutral-100">{{ $supplier->contact_name }}
                                </td>
